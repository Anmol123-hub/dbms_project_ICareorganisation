...
function buildIWContent(place) {
  ...
  document.getElementById("iw-icon").innerHTML =
    '<img class="hotelIcon" ' + 'src="DBMS_logo_final.ico"/>';
    
  document.getElementById("iw-url").innerHTML =
    '<b><a href="' + place.url + '">' + place.name + "</a></b>";
    
    document.getElementById("url1").value =place.name;  
  ...
  document.getElementById("iw-address").textContent = place.vicinity;
   ...
   document.getElementById("address").value = place.vicinity;
    ...
    var a=str.split(" ");
        var c=(a.length)-1;
     var  city=a[c]+" , LATITUDE AND LONGITUDE=>"+place.geometry.location;  
  ...
  if (place.formatted_phone_number) {
    ...
    document.getElementById("iw-phone-row").style.display = "none";
       ...
       document.getElementById("phno").value ="no phone number";
  ...
  if (place.rating) {
    ...
    document.getElementById("rate").value = "no rating";
  }
