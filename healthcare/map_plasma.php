...
while($r = mysqli_fetch_array($a1)){
    ...
    $check_id=0;
    $l=0;
    $querry = "SELECT * FROM `plasma_donation`";
      $query_ex = mysqli_query($db_con, $querry);
    while($r = mysqli_fetch_array($query_ex))
    {
        $check_id = $r["plasma_id"];
        if($l> $check_id )
    $check_id = $l;
     
   
    }
     $querry2 = "SELECT * FROM `plasma_donation` where `plasma_id`='$check_id';"; 
   ...
   $c1=0;
    $querry1 = "SELECT * FROM `plasma_map`";
    ...
    while($r = mysqli_fetch_array($query_ex1))
    {
     ...
     if($map_id==$check_id)
     {
         ...
         $sql1="UPDATE `plasma_map` SET `name`='$name',`age`='$age' ,`email`='$email1',`user_number`='$user_number',`donation_date`='$don_date',`expiry_date`='$expiry',`country`='$count',`city`='$c',`blood_bank`='$b',`address`='$ad',`phone_number`='$p',`rating`='$rate',`website`='$w',`user_id`='$id',`map_id`='$check_id' WHERE `map_id` = '$check_id';";
...
$sql="INSERT INTO `plasma_map`(`name`,`age`,`email`,`user_number`,`donation_date`,`expiry_date`,`country`, `city`, `blood_bank`, `address`, `phone_number`,`rating`, `website`, `user_id`,`map_id`) VALUES ('$name','$age','$email1','$user_number','$don_date','$expiry','$count','$c','$b','$ad','$p','$rate','$w','$id','$check_id');";
...
<form method="post" action="cancel_plasma.php" style="margin-top:10px">
