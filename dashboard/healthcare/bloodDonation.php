...
head.appendChild(style);
 ...
 a.document.write('</body><div align="center"><button align="center" style="margin-top:20px;"onclick="window.print()"><span>Print</span></button></div></html>');
    ...
    <body>
            ...
            $total=$data+$data1;
         $q2="Select * from blood_donation where user_id='$id';";
      $q1 = mysqli_query($db_con, $q2);
            ...
            while($r = mysqli_fetch_array($q1)){
             ...
             $querry3="Select * from blood_map where user_id='$id';";
      $query_ex2 = mysqli_query($db_con, $querry3);
            ...
            if($m==0 || $k==0)
            {?>
                <h1 align="center" style="margin-top:200px">You did not Donate Blood</h1>
                <h1 align="center" >To donate click the button below    <i class="fas fa-hand-point-down"></i></h1>
                <div class="row" align="center">
                    
                <a href="../../healthcare/blood_donation.html" target="_top"><button class="button" align="center"><span>Donate Blood </span></button></a>
               </div>
    ...
    //   alert(map);
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Entries', 'Values'],
          ['Your entry for booking blood bank',     map],
          ['Your entry for filling form for blood donation',      donate],
          ['Total entries for filling blood donation form and book blood bank',      total],
...
<div id="print">
  <section>
  <!--for demo wrap-->
  <h1 align="center"><i class="fas fa-hand-holding-heart" aria-hidden="true"></i>     Your Blood Donation Data</h1>
  ...
  <!--<div class="tbl-header" style="margin-top:50px">-->
      ...
      <thead>
        <tr style="  background-color: rgba(255,255,300,0.3);">
          ...
          <th>Have transmittable Disease or not</th>
          <th>Blood Group</th>
          <th>Donation Date</th>
          <th>Expiry Date</th>
...
// $querry = "SELECT a.name,a.email,a.phone,a.age,a.height,a.weight,a.diastolic_BP,a.systolic_BP,a.haemoglobin,a.pulse_rate,a.body_temperature,a.trans_disaese,a.blood_group,a.donation_date,a.expiry_date,a.blood_id, b.country, b.city,b.blood_bank, b.address,b.phone_number,b.rating,b.website FROM blood_donation a INNER JOIN blood_map b ON a.user_id = b.user_id ";
         $querry2="Select * from blood_donation where user_id='$id';";
...
?>
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo $r['diastolic_BP'];?></td>
          <td><?php echo $r['systolic_BP'];?></td>
          <td><?php echo $r['haemoglobin'];?></td>
          <td><?php echo $r['pulse_rate'];?></td>
          <td><?php echo $r['body_temperature'];?></td>
          <td><?php echo $r['trans_disaese'];?></td>
...
?>
  ...
  <h1 align="center"><i class="fas fa-map-marked-alt" aria-hidden="true"></i>     Your Blood Bank and Location Data</h1>
<section class="table-scroll">
   <!--<div id="print">-->
  <!--<div class="tbl-header" style="margin-top:50px">-->
    <table cellpadding="1" cellspacing="1" style="float:center" align="center">
...
<?php
// $querry = "SELECT a.name,a.email,a.phone,a.age,a.height,a.weight,a.diastolic_BP,a.systolic_BP,a.haemoglobin,a.pulse_rate,a.body_temperature,a.trans_disaese,a.blood_group,a.donation_date,a.expiry_date,a.blood_id, b.country, b.city,b.blood_bank, b.address,b.phone_number,b.rating,b.website FROM blood_donation a INNER JOIN blood_map b ON a.user_id = b.user_id ";
         $querry2="Select * from blood_map where user_id='$id';";
      $query_ex = mysqli_query($db_con, $querry2);
