...
head.appendChild(style);
 ...
 a.document.write('</body><div align="center"><button align="center" style="margin-top:20px;"onclick="window.print()"><span>Print</span></button></div></html>');
    ...
    <body>
        <?php
                         $q2="Select * from plasma_donation;";
            ...
            $total=$data+$data1;
         $querry2="Select * from plasma_donation where user_id='$id';";
      $query_ex = mysqli_query($db_con, $querry2);
            while($r = mysqli_fetch_array($query_ex)){
             ...
             $querry3="Select * from plasma_map where user_id='$id';";
      $query_ex1 = mysqli_query($db_con, $querry3);
            ...
            if($m==0 || $k==0)
            {?>
                <h1 align="center" style="margin-top:200px">You did not Donate Plasma</h1>
                <h1 align="center" >To donate click the button below   <i class="fas fa-hand-point-down"></i></h1>
                
                <div class="row" align="center">
                   
                <a href="../../healthcare/plasma_donation.html" target="_top"><button class="button" align="center"><span>Donate Plasma </span></button></a>
               </div>
           <?php }
           else
           {
    ...
    //   alert(map);
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Your entry for filling form for plasma donation',      donate],
          ['Total entries for filling plasma donation form and book blood bank',      total],
  ...
  <section>
  <!--for demo wrap-->
  <h1 align="center"><i class="fas fa-ribbon" aria-hidden="true"></i>     Your Plasma Donation Data</h1>
    ...
    <table cellpadding="1" cellspacing="1" style="float:center" align="center">
      <thead>
        <tr style="  background-color: rgba(255,255,300,0.3);">
          ...
          <th>Height</th>
          <th>Weight</th>
          <th>Protien Intake</th>
         <th>Body Temperature</th>
         <th>Have transmittable Disease or not</th>
          <th>Suffered from COVID19 or not</th>
          <th>Blood Group</th>
          <th>Donation Date</th>
          <th>Expiry Date</th>
...
?>
      ...
      <tbody>
        <tr>
          ...
          <td><?php echo $r['protien_intake'];?></td>
            <td><?php echo $r['temp'];?></td>
         
        
          <td><?php echo $r['trans_disease'];?></td>
          <td><?php echo $r['covid_sufferance'];?></td>
...
// $querry = "SELECT a.name,a.email,a.phone,a.age,a.height,a.weight,a.diastolic_BP,a.systolic_BP,a.haemoglobin,a.pulse_rate,a.body_temperature,a.trans_disaese,a.blood_group,a.donation_date,a.expiry_date,a.blood_id, b.country, b.city,b.blood_bank, b.address,b.phone_number,b.rating,b.website FROM blood_donation a INNER JOIN blood_map b ON a.user_id = b.user_id ";
         $querry2="Select * from plasma_map where user_id='$id';";
      $query_ex = mysqli_query($db_con, $querry2);
