...
v = place;
  if (place.geometry && place.geometry.location) {
    ...
    const features = [
          {
            position: new google.maps.LatLng(lat+0.007, lng+0.014),
            type: "icare",
          },
          {
            position: new google.maps.LatLng(lat-0.013, lng+0.010),
            type: "icare",
          },
          {
            position: new google.maps.LatLng(lat+0.012, lng-0.007),
            type: "icare",
          },
        ];
...
<br>
    <div class="hotel-search" align="center">
      ...
      <div id="locationField">
        <input  id="autocomplete" value="<?php echo $_SESSION['address1'] ?>" type="text"  style="width:500px;" />
      </div>

    </div>
    <br>
    <form name="form1" action="book_return_map.php" method="post" onsubmit="return(check())">
    <div id="map"></div>
    <br>
